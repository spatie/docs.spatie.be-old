...
This backup package requires **PHP 7.2**, with the [ZIP module](http://php.net/manual/en/book.zip.php) and **Laravel 5.7 or higher**. It's not compatible with Windows servers.
