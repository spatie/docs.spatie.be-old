...
If you only want to regenerate images for a few specific model instances, you can pass their IDs using the `--ids` option:

```bash
$ php artisan medialibrary:regenerate "App\Post" --ids=1 --ids=2 --ids=3
```
