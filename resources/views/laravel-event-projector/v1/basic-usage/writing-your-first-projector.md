...
This section is a perfect entry point to get yourself aquinted with the package. Most examples in these docs are also avaible in the Laravel app you'll find in this [this repo on GitHub](https://github.com/spatie/laravel-event-projector-demo-app). Clone that repo to toy around with the package.
